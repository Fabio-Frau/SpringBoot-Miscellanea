...
public final class TestDataUtil {
    ...
    public static BookEntity createTestEntityBookB(final AuthorEntity authorEntity) {
        return BookEntity.builder()
    ...
    public static BookEntity createTestEntityBookC(final AuthorEntity authorEntity) {
        return BookEntity.builder()
