...
import com.fabiofrau.RestAPi.TestDataUtil;
...
public class BookEntityRepositoryIntegrationTests {
    ...
    public void testThatMultipleBooksCanBeCreatedAndRecalled() {
        ...
        BookEntity bookEntityB = TestDataUtil.createTestEntityBookB(authorEntity);
        underTest.save(bookEntityB);

        BookEntity bookEntityC = TestDataUtil.createTestEntityBookC(authorEntity);
